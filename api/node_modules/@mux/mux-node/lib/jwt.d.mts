...
export declare const isMuxJWTSignOptionsMultiple: (config: MuxJWTSignOptions | MuxJWTSignOptionsMultiple) => config is MuxJWTSignOptionsMultiple;
...
export declare function sign(payload: object, secretOrPrivateKey: KeyLike, options: SignOptions): Promise<string>;
export declare function getSigningKey(mux: Mux, opts: MuxJWTSignOptions): string;
export declare function getPrivateKey(mux: Mux, opts: MuxJWTSignOptions): Promise<KeyLike>;
export {};
