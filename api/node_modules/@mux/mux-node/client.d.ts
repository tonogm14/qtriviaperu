...
import { type BasePageParams, BasePageResponse, type CursorPageParams, CursorPageResponse, type PageWithTotalParams, PageWithTotalResponse } from "./core/pagination.js";
import * as Uploads from "./core/uploads.js";
import * as API from "./resources/index.js";
import { APIPromise } from "./core/api-promise.js";
import { Data } from "./resources/data/data.js";
import { RobotsPreview } from "./resources/robots-preview/robots-preview.js";
...
export interface ClientOptions {
     ...
     * Set the log level.
     *
     * Defaults to process.env['MUX_LOG'] or 'warn' if it isn't set.
     */
...
export declare class Mux {
     ...
     */
    constructor({ baseURL, tokenId, tokenSecret, webhookSecret, jwtSigningKey, jwtPrivateKey, authorizationToken, ...opts }?: ClientOptions);
    /**
    ...
    protected accessTokenAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    protected authorizationTokenAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    ...
    video: API.Video;
    robotsPreview: API.RobotsPreview;
    data: API.Data;
    system: API.System;
