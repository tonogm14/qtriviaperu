...
export class Assets extends APIResource {
    ...
    retrieve(assetId, options) {
        return this._client.get(path `/video/v1/assets/${assetId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    update(assetId, body, options) {
        return this._client.patch(path `/video/v1/assets/${assetId}`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/video/v1/assets', (CursorPage), {
            query,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        });
    ...
    createPlaybackId(assetId, body, options) {
        return this._client.post(path `/video/v1/assets/${assetId}/playback-ids`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    createStaticRendition(assetId, body, options) {
        return this._client.post(path `/video/v1/assets/${assetId}/static-renditions`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    createTrack(assetId, body, options) {
        return this._client.post(path `/video/v1/assets/${assetId}/tracks`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    generateSubtitles(assetId, trackId, body, options) {
        return this._client.post(path `/video/v1/assets/${assetId}/tracks/${trackId}/generate-subtitles`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    retrieveInputInfo(assetId, options) {
        return this._client.get(path `/video/v1/assets/${assetId}/input-info`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    retrievePlaybackId(assetId, playbackId, options) {
        return this._client.get(path `/video/v1/assets/${assetId}/playback-ids/${playbackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    updateMasterAccess(assetId, body, options) {
        return this._client.put(path `/video/v1/assets/${assetId}/master-access`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    updateMP4Support(assetId, body, options) {
        return this._client.put(path `/video/v1/assets/${assetId}/mp4-support`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
