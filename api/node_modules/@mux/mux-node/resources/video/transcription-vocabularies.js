...
exports.TranscriptionVocabularies = void 0;
 ...
 */
class TranscriptionVocabularies extends resource_1.APIResource {
    /**
     ...
     */
    create(body, options) {
        return this._client.post('/video/v1/transcription-vocabularies', {
            body,
    ...
    retrieve(transcriptionVocabularyID, options) {
        return this._client.get((0, path_1.path) `/video/v1/transcription-vocabularies/${transcriptionVocabularyID}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    update(transcriptionVocabularyID, body, options) {
        return this._client.put((0, path_1.path) `/video/v1/transcription-vocabularies/${transcriptionVocabularyID}`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/video/v1/transcription-vocabularies', (pagination_1.BasePage), { query, defaultBaseURL: 'https://api.mux.com', ...options });
    }
    /**
    ...
    delete(transcriptionVocabularyID, options) {
        return this._client.delete((0, path_1.path) `/video/v1/transcription-vocabularies/${transcriptionVocabularyID}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
...
exports.TranscriptionVocabularies = TranscriptionVocabularies;
//# sourceMappingURL=transcription-vocabularies.js.map