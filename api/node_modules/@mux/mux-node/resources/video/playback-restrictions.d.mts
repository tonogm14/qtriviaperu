...
export declare class PlaybackRestrictions extends APIResource {
     ...
     * ```
     */
    list(query?: PlaybackRestrictionListParams | null | undefined, options?: RequestOptions): PagePromise<PlaybackRestrictionsBasePage, PlaybackRestriction>;
    /**
     ...
     * ```
     */
    updateReferrer(playbackRestrictionID: string, body: PlaybackRestrictionUpdateReferrerParams, options?: RequestOptions): APIPromise<PlaybackRestriction>;
    /**
     ...
     * ```
     */
    updateUserAgent(playbackRestrictionID: string, body: PlaybackRestrictionUpdateUserAgentParams, options?: RequestOptions): APIPromise<PlaybackRestriction>;
}
...
export declare namespace PlaybackRestrictions {
    export { type PlaybackRestriction as PlaybackRestriction, type PlaybackRestrictionResponse as PlaybackRestrictionResponse, type PlaybackRestrictionsBasePage as PlaybackRestrictionsBasePage, type PlaybackRestrictionCreateParams as PlaybackRestrictionCreateParams, type PlaybackRestrictionListParams as PlaybackRestrictionListParams, type PlaybackRestrictionUpdateReferrerParams as PlaybackRestrictionUpdateReferrerParams, type PlaybackRestrictionUpdateUserAgentParams as PlaybackRestrictionUpdateUserAgentParams, };
}
//# sourceMappingURL=playback-restrictions.d.mts.map