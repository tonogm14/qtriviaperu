...
class Assets extends resource_1.APIResource {
    ...
    retrieve(assetId, options) {
        return this._client.get((0, path_1.path) `/video/v1/assets/${assetId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    update(assetId, body, options) {
        return this._client.patch((0, path_1.path) `/video/v1/assets/${assetId}`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/video/v1/assets', (pagination_1.CursorPage), {
            query,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        });
    ...
    delete(assetId, options) {
        return this._client.delete((0, path_1.path) `/video/v1/assets/${assetId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
    ...
    createPlaybackId(assetId, body, options) {
        return this._client.post((0, path_1.path) `/video/v1/assets/${assetId}/playback-ids`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    createStaticRendition(assetId, body, options) {
        return this._client.post((0, path_1.path) `/video/v1/assets/${assetId}/static-renditions`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    createTrack(assetId, body, options) {
        return this._client.post((0, path_1.path) `/video/v1/assets/${assetId}/tracks`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    deletePlaybackId(assetId, playbackId, options) {
        return this._client.delete((0, path_1.path) `/video/v1/assets/${assetId}/playback-ids/${playbackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    deleteStaticRendition(assetId, staticRenditionId, options) {
        return this._client.delete((0, path_1.path) `/video/v1/assets/${assetId}/static-renditions/${staticRenditionId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    deleteTrack(assetId, trackId, options) {
        return this._client.delete((0, path_1.path) `/video/v1/assets/${assetId}/tracks/${trackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    /**
     * Generates subtitles (captions) for a given audio track.
     * [See docs for more information.](https://mux.com/docs/guides/add-autogenerated-captions-and-use-transcripts#retroactively-enable-auto-generated-captions)
     *
     * @example
     * ```ts
    ...
    generateSubtitles(assetId, trackId, body, options) {
        return this._client.post((0, path_1.path) `/video/v1/assets/${assetId}/tracks/${trackId}/generate-subtitles`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    retrieveInputInfo(assetId, options) {
        return this._client.get((0, path_1.path) `/video/v1/assets/${assetId}/input-info`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    retrievePlaybackId(assetId, playbackId, options) {
        return this._client.get((0, path_1.path) `/video/v1/assets/${assetId}/playback-ids/${playbackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    updateMasterAccess(assetId, body, options) {
        return this._client.put((0, path_1.path) `/video/v1/assets/${assetId}/master-access`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    updateMP4Support(assetId, body, options) {
        return this._client.put((0, path_1.path) `/video/v1/assets/${assetId}/mp4-support`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
