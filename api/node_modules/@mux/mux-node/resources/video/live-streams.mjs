...
export class LiveStreams extends APIResource {
    ...
    retrieve(liveStreamId, options) {
        return this._client.get(path `/video/v1/live-streams/${liveStreamId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    update(liveStreamId, body, options) {
        return this._client.patch(path `/video/v1/live-streams/${liveStreamId}`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/video/v1/live-streams', (BasePage), {
            query,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        });
    ...
    createPlaybackId(liveStreamId, body, options) {
        return this._client.post(path `/video/v1/live-streams/${liveStreamId}/playback-ids`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    createSimulcastTarget(liveStreamId, body, options) {
        return this._client.post(path `/video/v1/live-streams/${liveStreamId}/simulcast-targets`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    deleteNewAssetSettingsStaticRenditions(liveStreamId, options) {
        return this._client.delete(path `/video/v1/live-streams/${liveStreamId}/new-asset-settings/static-renditions`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    deletePlaybackId(liveStreamId, playbackId, options) {
        return this._client.delete(path `/video/v1/live-streams/${liveStreamId}/playback-ids/${playbackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    deleteSimulcastTarget(liveStreamId, simulcastTargetId, options) {
        return this._client.delete(path `/video/v1/live-streams/${liveStreamId}/simulcast-targets/${simulcastTargetId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    disable(liveStreamId, options) {
        return this._client.put(path `/video/v1/live-streams/${liveStreamId}/disable`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    enable(liveStreamId, options) {
        return this._client.put(path `/video/v1/live-streams/${liveStreamId}/enable`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    resetStreamKey(liveStreamId, options) {
        return this._client.post(path `/video/v1/live-streams/${liveStreamId}/reset-stream-key`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    retrievePlaybackId(liveStreamId, playbackId, options) {
        return this._client.get(path `/video/v1/live-streams/${liveStreamId}/playback-ids/${playbackId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    retrieveSimulcastTarget(liveStreamId, simulcastTargetId, options) {
        return this._client.get(path `/video/v1/live-streams/${liveStreamId}/simulcast-targets/${simulcastTargetId}`, {
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    }
    ...
    updateEmbeddedSubtitles(liveStreamId, body, options) {
        return this._client.put(path `/video/v1/live-streams/${liveStreamId}/embedded-subtitles`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    updateGeneratedSubtitles(liveStreamId, body, options) {
        return this._client.put(path `/video/v1/live-streams/${liveStreamId}/generated-subtitles`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
    ...
    updateNewAssetSettingsStaticRenditions(liveStreamId, body, options) {
        return this._client.put(path `/video/v1/live-streams/${liveStreamId}/new-asset-settings/static-renditions`, {
            body,
            defaultBaseURL: 'https://api.mux.com',
            ...options,
        })._thenUnwrap((obj) => obj.data);
