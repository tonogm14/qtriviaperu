...
async function main() {
    ...
    const userPassword = await bcryptjs_1.default.hash('User1234!', 12);
    ...
    const staffPassword = await bcryptjs_1.default.hash('Staff1234!', 12);
    ...
    const users = await Promise.all(usersData.map((u) => prisma.user.upsert({
        where: { email: u.email },
        update: {},
    ...
    if (existingQuestions === 0) {
        ...
        const questionsData = [
            // Historia
            { text: '¿En qué año se declaró la independencia del Perú?', options: ['1821', '1824', '1810'], correctIndex: 0, category: 'Historia', difficulty: client_1.Difficulty.EASY },
            { text: '¿Quién proclamó la independencia del Perú?', options: ['José de San Martín', 'Simón Bolívar', 'Ramón Castilla'], correctIndex: 0, category: 'Historia', difficulty: client_1.Difficulty.EASY },
            { text: '¿En qué batalla se consolidó la independencia del Perú en 1824?', options: ['Batalla de Junín', 'Batalla de Ayacucho', 'Batalla de Pisagua'], correctIndex: 1, category: 'Historia', difficulty: client_1.Difficulty.MEDIUM },
            { text: '¿Cuál fue el último Sapa Inca antes de la conquista española?', options: ['Huáscar', 'Atahualpa', 'Manco Inca'], correctIndex: 1, category: 'Historia', difficulty: client_1.Difficulty.MEDIUM },
            { text: '¿En qué año Francisco Pizarro fundó la ciudad de Lima?', options: ['1535', '1532', '1521'], correctIndex: 0, category: 'Historia', difficulty: client_1.Difficulty.HARD },
            { text: '¿Qué civilización construyó la ciudadela de Machu Picchu?', options: ['Los Incas', 'Los Wari', 'Los Nazca'], correctIndex: 0, category: 'Historia', difficulty: client_1.Difficulty.EASY },
            // Gastronomía
            { text: '¿Cuál es el ingrediente principal del ceviche peruano?', options: ['Pescado fresco', 'Mariscos', 'Pollo'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.EASY },
            { text: '¿Con qué se cocina el ceviche en Perú (la "leche de tigre")?', options: ['Jugo de limón', 'Vinagre blanco', 'Salsa de soya'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.EASY },
            { text: '¿Qué papa se usa tradicionalmente en la causa limeña?', options: ['Papa amarilla', 'Papa blanca', 'Papa morada'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.MEDIUM },
            { text: '¿Cuál es el principal ingrediente del ají de gallina?', options: ['Ají amarillo', 'Ají panca', 'Ají mirasol'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.MEDIUM },
            { text: '¿De qué región es originario el plato "juane"?', options: ['Selva peruana', 'Costa peruana', 'Sierra peruana'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.MEDIUM },
            { text: '¿Cuál bebida fermentada de maíz es tradicional en los Andes peruanos?', options: ['Chicha de jora', 'Macerado de frutas', 'Guarapo'], correctIndex: 0, category: 'Gastronomía', difficulty: client_1.Difficulty.EASY },
        ];
